...
function F(a){var b=a.localName,c="";b?-1<b.indexOf("-")||(c=b,b=a.getAttribute&&a.getAttribute("is")||""):(b=a.is,c=a.extends);return{is:b,u:c}};var G=null,Da=window.HTMLImports&&window.HTMLImports.whenReady||null,H;function Ea(a){requestAnimationFrame(function(){Da?Da(a):(G||(G=new Promise(function(a){H=a}),"complete"===document.readyState?H():document.addEventListener("readystatechange",function(){"complete"===document.readyState&&H()})),G.then(function(){a&&a()}))})};function I(){}function J(a,b,c){var e=K;a.__styleScoped?a.__styleScoped=null:Fa(e,a,b||"",c)}function Fa(a,b,c,e){b.nodeType===Node.ELEMENT_NODE&&Ga(b,c,e);if(b="template"===b.localName?(b.content||b.R).childNodes:b.children||b.childNodes)for(var d=0;d<b.length;d++)Fa(a,b[d],c,e)}function L(a){for(var b=0,c=0;c<a.length;c++)b+=Math.pow(31*a.charCodeAt(c),a.length-c),b&=b;return"style-scope-"+a+"-"+Math.abs(b)}
function Ga(a,b,c){if(b){var e=L(b);if(a.classList)c?(a.classList.remove("style-scope"),a.classList.remove(b)):(a.classList.add("style-scope"),a.classList.add(e));else if(a.getAttribute){var d=a.getAttribute(Ha);c?d&&(b=d.replace("style-scope","").replace(b,""),E(a,b)):E(a,(d?d+" ":"")+"style-scope "+e)}}}function M(a,b,c){var e=K,d=a.__cssBuild;t||"shady"===d?b=z(b,c):(a=F(a),b=Ia(e,b,a.is,a.u,c)+"\n\n");return b.trim()}
function Ia(a,b,c,e,d){var f=Ja(c,e);c=c?Ka+L(c):"";return z(b,function(b){b.c||(b.selector=b.g=La(a,b,a.b,c,f),b.c=!0);d&&d(b,c,f)})}function Ja(a,b){return b?"[is="+a+"]":a}function La(a,b,c,e,d){var f=b.selector.split(Ma);if(!Aa(b)){b=0;for(var h=f.length,g;b<h&&(g=f[b]);b++)f[b]=c.call(a,g,e,d)}return f.join(Ma)}function Na(a){return a.replace(Oa,function(a,c,e){-1<e.indexOf("+")?e=e.replace(/\+/g,"___"):-1<e.indexOf("___")&&(e=e.replace(/___/g,"+"));return":"+c+"("+e+")"})}
I.prototype.b=function(a,b,c){var e=!1;a=a.trim();var d=Oa.test(a);d&&(a=a.replace(Oa,function(a,b,c){return":"+b+"("+c.replace(/\s/g,"")+")"}),a=Na(a));a=a.replace(Pa,Qa+" $1");a=a.replace(Ra,function(a,d,g){e||(a=Sa(g,d,b,c),e=e||a.stop,d=a.H,g=a.value);return d+g});d&&(a=Na(a));return a};
function Sa(a,b,c,e){var d=a.indexOf(Ta);0<=a.indexOf(Qa)?a=Ua(a,e):0!==d&&(a=c?Va(a,c):a);c=!1;0<=d&&(b="",c=!0);if(c){var f=!0;c&&(a=a.replace(Wa,function(a,b){return" > "+b}))}a=a.replace(Xa,function(a,b,c){return'[dir="'+c+'"] '+b+", "+b+'[dir="'+c+'"]'});return{value:a,H:b,stop:f}}function Va(a,b){a=a.split(Ya);a[0]+=b;return a.join(Ya)}
function Ua(a,b){var c=a.match(Za);return(c=c&&c[2].trim()||"")?c[0].match($a)?a.replace(Za,function(a,c,f){return b+f}):c.split($a)[0]===b?c:ab:a.replace(Qa,b)}function bb(a){a.selector===cb&&(a.selector="html")}I.prototype.c=function(a){return a.match(Ta)?this.b(a,db):Va(a.trim(),db)};aa.Object.defineProperties(I.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"style-scope"}}});
var Oa=/:(nth[-\w]+)\(([^)]+)\)/,db=":not(.style-scope)",Ma=",",Ra=/(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g,$a=/[[.:#*]/,Qa=":host",cb=":root",Ta="::slotted",Pa=new RegExp("^("+Ta+")"),Za=/(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Wa=/(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Xa=/(.*):dir\((?:(ltr|rtl))\)/,Ka=".",Ya=":",Ha="class",ab="should_not_match",K=new I;function eb(){}
...
if(!t){var gb=new MutationObserver(fb),hb=function(a){gb.observe(a,{childList:!0,subtree:!0})};if(window.customElements&&!window.customElements.polyfillWrapFlushCallback)hb(document);else{var ib=function(){hb(document.body)};window.HTMLImports?window.HTMLImports.whenReady(ib):requestAnimationFrame(function(){if("loading"===document.readyState){var a=function(){ib();document.removeEventListener("readystatechange",a)};document.addEventListener("readystatechange",a)}else ib()})}eb=function(){fb(gb.takeRecords())}}
var jb=eb;function N(a,b,c,e,d){this.j=a||null;this.b=b||null;this.B=c||[];this.s=null;this.u=d||"";this.a=this.h=this.m=null}function O(a){return a?a.__styleInfo:null}function kb(a,b){return a.__styleInfo=b}N.prototype.c=function(){return this.j};N.prototype._getStyleRules=N.prototype.c;var P=window.Element.prototype,lb=P.matches||P.matchesSelector||P.mozMatchesSelector||P.msMatchesSelector||P.oMatchesSelector||P.webkitMatchesSelector,mb=navigator.userAgent.match("Trident");function nb(){}function ob(a){var b={},c=[],e=0;A(a,function(a){R(a);a.index=e++;a=a.f.cssText;for(var c;c=va.exec(a);){var d=c[1];":"!==c[2]&&(b[d]=!0)}},function(a){c.push(a)});a.b=c;a=[];for(var d in b)a.push(d);return a}
...
function T(a,b,c){b&&(b=0<=b.indexOf(";")?pb(a,b,c):Ca(b,function(b,d,f,h){if(!d)return b+h;(d=T(a,c[d],c))&&"initial"!==d?"apply-shim-inherit"===d&&(d="inherit"):d=T(a,c[f]||f,c)||f;return b+(d||"")+h}));return b&&b.trim()||""}
function pb(a,b,c){b=b.split(";");for(var e=0,d,f;e<b.length;e++)if(d=b[e]){y.lastIndex=0;if(f=y.exec(d))d=T(a,c[f[1]],c);else if(f=d.indexOf(":"),-1!==f){var h=d.substring(f);h=h.trim();h=T(a,h,c)||h;d=d.substring(0,f)+h}b[e]=d&&d.lastIndexOf(";")===d.length-1?d.slice(0,-1):d||""}return b.join(";")}
function qb(a,b){var c={},e=[];A(a,function(a){a.f||R(a);var d=a.g||a.parsedSelector;b&&a.f.i&&d&&lb.call(b,d)&&(S(a,c),a=a.index,d=parseInt(a/32,10),e[d]=(e[d]||0)|1<<a%32)},null,!0);return{i:c,key:e}}
function rb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.u;b=a?Ja(a,b):"html";var f=c.parsedSelector,h=":host > *"===f||"html"===f,g=0===f.indexOf(":host")&&!h;"shady"===e&&(h=f===b+" > *."+b||-1!==f.indexOf("html"),g=!h&&0===f.indexOf(b));"shadow"===e&&(h=":host > *"===f||"html"===f,g=g&&!h);if(h||g)e=b,g&&(t&&!c.g&&(c.g=La(K,c,K.b,a?Ka+L(a):"",b)),e=c.g||b),d({M:e,K:g,S:h})}}
function sb(a,b){var c={},e={},d=U,f=b&&b.__cssBuild;A(b,function(b){rb(d,a,b,f,function(d){lb.call(a.A||a,d.M)&&(d.K?S(b,c):S(b,e))})},null,!0);return{L:e,J:c}}
function tb(a,b,c,e){var d=F(b),f=Ja(d.is,d.u),h=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])");d=O(b).j;var g=ub(d,e);return M(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=pb(a,b.f.cssText,c));b.cssText=d;if(!t&&!Aa(b)&&b.cssText){var k=d=b.cssText;null==b.C&&(b.C=wa.test(d));if(b.C)if(null==b.w){b.w=[];for(var q in g)k=g[q],k=k(d),d!==k&&(d=k,b.w.push(q))}else{for(q=0;q<b.w.length;++q)k=g[b.w[q]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;q=b.g.split(",");
k=0;for(var Ab=q.length,Q;k<Ab&&(Q=q[k]);k++)q[k]=Q.match(h)?Q.replace(f,d):d+" "+Q;b.selector=q.join(",")}})}function ub(a,b){a=a.b;var c={};if(!t&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,h=b;f.l=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+h;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=vb(d)}return c}function vb(a){return function(b){return b.replace(a.l,a.a)}}
function wb(a,b){var c=U,e=B(a);a.textContent=z(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(ma,"").replace(na,""),a.cssText=pb(c,d,b))})}aa.Object.defineProperties(nb.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var U=new nb;var xb={},V=window.customElements;if(V&&!t){var yb=V.define;V.define=function(a,b,c){var e=document.createComment(" Shady DOM styles for "+a+" "),d=document.head;d.insertBefore(e,(D?D.nextSibling:null)||d.firstChild);D=e;xb[a]=e;return yb.call(V,a,b,c)}};var W=new function(){this.cache={};this.a=100};function X(){var a=this;this.A={};this.c=document.documentElement;var b=new n;b.rules=[];this.l=kb(this.c,new N(b));this.v=!1;this.b=this.a=null;Ea(function(){Y(a)})}l=X.prototype;l.F=function(){jb()};l.I=function(a){return B(a)};l.O=function(a){return z(a)};
...
t||J(a.content,b);Y(this);f=y.test(d)||w.test(d);y.lastIndex=0;w.lastIndex=0;d=p(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.v=e;e=[];v||(e=ob(a._styleAst));if(!e.length||v)d=t?a.content:null,b=xb[b],f=M(c,a._styleAst),b=f.length?C(f,c.is,d,b):void 0,a.a=b;a.c=e}};
function zb(a){!a.b&&window.ShadyCSS&&window.ShadyCSS.CustomStyleInterface&&(a.b=window.ShadyCSS.CustomStyleInterface,a.b.transformCallback=function(b){a.D(b)},a.b.validateCallback=function(){requestAnimationFrame(function(){(a.b.enqueued||a.v)&&a.o()})})}function Y(a){!a.a&&window.ShadyCSS&&window.ShadyCSS.ApplyShim&&(a.a=window.ShadyCSS.ApplyShim,a.a.invalidCallback=ra);zb(a)}
l.o=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued){if(v)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&v&&this.a){var e=B(c);Y(this);this.a.transformRules(e);c.textContent=z(e)}}else for(Bb(this,this.c,this.l),b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&wb(c,this.l.m);this.b.enqueued=!1;this.v&&!v&&this.styleDocument()}}};
l.styleElement=function(a,b){var c=F(a).is,e=O(a);if(!e){var d=F(a);e=d.is;d=d.u;var f=xb[e];e=m[e];if(e){var h=e._styleAst;var g=e.c}e=kb(a,new N(h,f,g,0,d))}a!==this.c&&(this.v=!0);b&&(e.s=e.s||{},Object.assign(e.s,b));if(v){if(e.s){b=e.s;for(var k in b)null===k?a.style.removeProperty(k):a.style.setProperty(k,b[k])}if(((k=m[c])||a===this.c)&&k&&k.a&&!sa(k)){if(sa(k)||k._applyShimValidatingVersion!==k._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(k._styleAst,c),k.a.textContent=M(a,
e.j),ta(k);t&&(c=a.shadowRoot)&&(c.querySelector("style").textContent=M(a,e.j));e.j=k._styleAst}}else if(Bb(this,a,e),e.B&&e.B.length){c=e;k=F(a).is;a:{if(b=W.cache[k])for(h=b.length-1;0<=h;h--){g=b[h];b:{e=c.B;for(d=0;d<e.length;d++)if(f=e[d],g.i[f]!==c.m[f]){e=!1;break b}e=!0}if(e){b=g;break a}}b=void 0}e=b?b.styleElement:null;h=c.h;(g=b&&b.h)||(g=this.A[k]=(this.A[k]||0)+1,g=k+"-"+g);c.h=g;g=c.h;d=U;d=e?e.textContent||"":tb(d,a,c.m,g);f=O(a);var x=f.a;x&&!t&&x!==e&&(x._useCount--,0>=x._useCount&&
x.parentNode&&x.parentNode.removeChild(x));t?f.a?(f.a.textContent=d,e=f.a):d&&(e=C(d,g,a.shadowRoot,f.b)):e?e.parentNode||(mb&&-1<d.indexOf("@media")&&(e.textContent=d),Ba(e,null,f.b)):d&&(e=C(d,g,null,f.b));e&&(e._useCount=e._useCount||0,f.a!=e&&e._useCount++,f.a=e);g=e;t||(e=c.h,f=d=a.getAttribute("class")||"",h&&(f=d.replace(new RegExp("\\s*x-scope\\s*"+h+"\\s*","g")," ")),f+=(f?" ":"")+"x-scope "+e,d!==f&&E(a,f));b||(a=W.cache[k]||[],a.push({i:c.m,styleElement:g,h:c.h}),a.length>W.a&&a.shift(),
W.cache[k]=a)}};function Cb(a,b){return(b=b.getRootNode().host)?O(b)?b:Cb(a,b):a.c}function Bb(a,b,c){a=Cb(a,b);var e=O(a);a=Object.create(e.m||null);var d=sb(b,c.j);b=qb(e.j,b).i;Object.assign(a,d.J,b,d.L);b=c.s;for(var f in b)if((d=b[f])||0===d)a[f]=d;f=U;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=T(f,a[e],a);c.m=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=B(a);A(c,function(a){if(t)bb(a);else{var c=K;a.selector=a.parsedSelector;bb(a);a.selector=a.g=La(c,a,c.c,void 0,void 0)}v&&(Y(b),b.a&&b.a.transformRule(a))});v?a.textContent=z(c):this.l.j.rules.push(c)};
l.getComputedStyleValue=function(a,b){var c;v||(c=(O(a)||O(Cb(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};l.N=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===K.a){c=e[d+1];break}}}c&&b.push(K.a,L(c));v||(c=O(a))&&c.h&&b.push(U.a,c.h);E(a,b.join(" "))};l.G=function(a){return O(a)};X.prototype.flush=X.prototype.F;
...
X.prototype.flushCustomStyles=X.prototype.o;Object.defineProperties(X.prototype,{nativeShadow:{get:function(){return t}},nativeCss:{get:function(){return v}}});var Z=new X,Db,Eb;window.ShadyCSS&&(Db=window.ShadyCSS.ApplyShim,Eb=window.ShadyCSS.CustomStyleInterface);window.ShadyCSS={ScopingShim:Z,prepareTemplate:function(a,b,c){Z.o();Z.prepareTemplate(a,b,c)},styleSubtree:function(a,b){Z.o();Z.styleSubtree(a,b)},styleElement:function(a){Z.o();Z.styleElement(a)},styleDocument:function(a){Z.o();Z.styleDocument(a)},getComputedStyleValue:function(a,b){return Z.getComputedStyleValue(a,b)},nativeCss:v,nativeShadow:t};Db&&(window.ShadyCSS.ApplyShim=Db);
Eb&&(window.ShadyCSS.CustomStyleInterface=Eb);}).call(this);
